                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-validation">
                            <form action="{{ route('arsip.store') }}" method="POST" enctype="multipart/form-data" class="form-valide">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="custom-file">
                                            <input type="file" name="file_arsip" class="custom-file-input" accept=".pdf">
